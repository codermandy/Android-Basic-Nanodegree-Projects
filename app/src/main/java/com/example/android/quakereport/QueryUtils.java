...
/**
 * Created by codermandy on 18/2/18.
 */
...
public final class QueryUtils {
    ...
    public static ArrayList<Earthquake> extractEarthquakes() {
        ...
        try {
            ...
            //it contains magnitude location and time of earthquake
            JSONArray earthquakeArray= baseJSONResponse.getJSONArray("features");
            //STEP3: Loop through each feature in earthquakeArray object of type JSONArray
            for(int i=0;i<earthquakeArray.length();i++) {
                //STEP4: Get earthquakeJSON Object  at position i also get its properties
                //pulls out json object at specified position of earthquake array
                JSONObject currentEarthquake= earthquakeArray.getJSONObject(i);
                JSONObject properties=currentEarthquake.getJSONObject("properties");
                //STEP 5 : Extract magnitude time and location from properties
                ...
                //Extract value of string key called url
                String url= properties.getString("url");

                //Create a new {@link Earthquake} object with magnitude,location time
                //and url from JSON Response
                Earthquake earthquake=  new Earthquake(magnitude,location,time ,url);
                //STEP 7: Add earthquake to list of earthquake
